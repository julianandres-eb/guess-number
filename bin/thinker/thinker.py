...
def main():
    ...
    print("- We'll start making some questionnaire like 'How many digits has the number?'")
    ...
    print("  If not, we'll keep bothering you with questionnaire until we determine the number")
    print("------------------------------------------------------------------------------------")
