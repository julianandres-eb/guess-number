...
# - You have to guess a number between 0 and 9999 (that means 4 digits)

# - These 4 digits cannot be repeated, for example: 1224

# - After you tell us, which number you think is correct, we'll help you by saying
#   how many numbers are in the right position (Good) and how many correspond to
#   the correct number but they aren't placed properly (Regular).
#
#   For example: if the correct number is 1234 and you write down 1273,
#   our response will be "2 Good, 1 Regular"
# -------------------------------------------------------------------------
